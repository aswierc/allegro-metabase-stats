        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    makeRequest = function (endpoint, opts) {
                        if (opts === void 0) { opts = {}; }
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!(tokens && tokens.refresh_token && helpers_1.getExpiresInHours(tokens) < 1)) return [3 /*break*/, 2];
                                    ...
                                    case 2:
                                        ...
                                        requestOptions = __assign(__assign({ uri: "" + apiUrl + endpoint, method: 'GET' }, opts), { headers: __assign({ Authorization: "Bearer " + tokens.access_token, Accept: 'application/vnd.allegro.public.v1+json' }, opts.headers) });
                                        return [2 /*return*/, new Promise(function (resolve, reject) {
